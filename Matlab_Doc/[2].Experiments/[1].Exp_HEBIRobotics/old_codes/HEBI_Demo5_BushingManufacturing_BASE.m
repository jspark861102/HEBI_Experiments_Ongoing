...
desired_force = [1000 -11 1000 1000 1000 1000]; %힘제어 적용 하고 싶지 않은 축은 값을 크게 설정하자
...
%% Target Waypoints          
[xyzTargets, rotMatTarget, control_time, gripperforce] = TargetWaypoints_Bushing_Base(demo_case);
...
%control setting
fbk = group.getNextFeedbackFull(); %초기자세 읽음
...
while t < trajectory.getDuration
    ...
    Te = fbk.deflection'.*[70 170 70 70 70 70]'; %Hebi spring constant
    Fe = inv(J')*Te;             
