...
def callback(msg):
    ...
    requesttovision_pub.publish("recog")
    print("I send request to vision")    
...
requesttovision_pub = rospy.Publisher('recog_on', String, queue_size=1)
requestfromMatlab_sub = rospy.Subscriber('requestfrommatlab', Int32, callback)
objpose_sub = rospy.Subscriber('/det/pick_object/obj_marker', Marker, marker_callback)
